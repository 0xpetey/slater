...
xcodebuild -project Slater.xcodeproj -scheme Slater -derivedDataPath build/DerivedData build
open build/DerivedData/Build/Products/Debug/Slater.app
```

Or open `Slater.xcodeproj` in Xcode after generating it.
